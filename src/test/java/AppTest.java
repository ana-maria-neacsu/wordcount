...
public class AppTest {
    ...
    private final App wordCounter = new App(new TestReader());
    ...
    public void testNoStopWordsFilePresent() {
        ...
        final App wordCounter = new App(new ErroringTestReader());
    ...
    public void countWordsTestWithNoStopWords() {
        ...
        Assert.assertEquals(4,wordCounter.countWords("Mary-Jane had a lamb.", new HashSet<String>()));
        Assert.assertEquals(1,wordCounter.countWords("-Mary-", new HashSet<String>()));
